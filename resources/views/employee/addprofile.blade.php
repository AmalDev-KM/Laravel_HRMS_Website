        ...
        <div class="container-fluid"> <!--begin::Row-->
            <div class="row g-4"> <!--begin::Col-->
                <div class="col-12">
                    ...
                    <p>Hello, [Employee User's Name]! <br>
                        Profile Update: Ensure your profile information is up to date. If you haven't completed your profile, please do so to gain full access to all features. <br>
                    </p>    
                    </div>
                ...
                <div class="col-md-12"> <!--begin::Quick Example-->
                    <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
                        <div class="card-header">
                            <div class="card-title">Add Profile Details</div>
                        </div> <!--end::Header--> <!--begin::Form-->
                        
                        <form class="needs-validation" action="{{route('employee.doUpdateProfile')}}" method="POST" enctype="multipart/form-data" novalidate> <!--begin::Body-->
                            @csrf
                            <div class="card-body"> <!--begin::Row-->
                                <div class="row g-3"> <!--begin::Col-->
                                    <div class="col-md-4"> 
                                        <label for="validationCustom01" class="form-label">First name</label> 
                                        <input type="text" class="form-control" name="first_name" value="{{Auth::guard('Employee')->user()->first_name}}" id="validationCustom01" required>
                                        <input type="hidden" name="employee_id" value="{{Auth::guard('Employee')->user()->id}}">
                                        <div class="valid-feedback">Looks good!</div>
                                    </div> <!--end::Col--> <!--begin::Col-->
                                    <div class="col-md-4"> 
                                        <label for="validationCustom02" class="form-label">Last name</label> 
                                        <input type="text" class="form-control" name="last_name" value="{{Auth::guard('Employee')->user()->last_name}}" id="validationCustom02" required>
                                        <div class="valid-feedback">Looks good!</div>
                                    </div> <!--end::Col--> <!--begin::Col-->
                                    <div class="col-md-4"> 
                                        <label for="validationCustom02" class="form-label">Email</label> 
                                        <input type="email" class="form-control" name="email" value="{{Auth::guard('Employee')->user()->email}}" id="validationCustom02" readonly required>
                                        <div class="valid-feedback">Looks good!</div>
                                    </div>
                                    <div class="col-md-4"> 
                                    ...
                                    <div class="col-md-4"> <label for="validationCustom04" class="form-label">Gender</label> 
                                    ...
                                    <div class="col-md-4"> <label for="validationCustom04" class="form-label">Blood group</label> 
                                    ...
                                    <div class="col-md-4"> <label for="validationCustom04" class="form-label">Select your Hr</label> 
                                        <select class="form-select" id="validationCustom04" name="reviewinghr" required>
                                            <option selected disabled value="">Choose...</option>
                                            @foreach ($hrs as $hr)
                                    ...
                                    <div class="col-md-4"> 
                                        ...
                                        <input type="file" class="form-control" name="profile_picture" id="inputGroupFile02">
                                    </div>
                                     <!--end::Col--> <!--begin::Col-->
                                     <!--end::Col-->
                                </div> <!--end::Row-->
