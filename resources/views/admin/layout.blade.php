            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> <a href="{{route('admin.department')}}" class="nav-link"> <i class="nav-icon bi bi-clipboard-fill"></i>
                            <p>Department</p>
                        </a> </li>
                        <li class="nav-item"> <a href="{{route('admin.jobrole')}}" class="nav-link"> <i class="nav-icon bi bi-ui-checks-grid"></i>
                            <p>Job Roles</p>
                        </a> </li>
                        <li class="nav-item"> <a href="{{route('admin.approveHr')}}" class="nav-link"> <i class="bi bi-person-plus-fill"></i>
                            <p>New HR Request</p>
                        </a> </li>
                    </ul> <!--end::Sidebar Menu-->
                </nav>
