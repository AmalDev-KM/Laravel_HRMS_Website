            ...
            <div class="row g-4"> <!--begin::Col-->
                ...
                <div class="col-md-12"> <!--begin::Quick Example-->
                    <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
                        ...
                        <form class="needs-validation" action="{{route('hr.updateprofile')}}" method="POST" enctype="multipart/form-data" novalidate> <!--begin::Body-->
                            @csrf
                            <div class="card-body"> <!--begin::Row-->
                                <div class="row g-3"> <!--begin::Col-->
                                    <div class="col-md-4"> 
                                        ...
                                        <input type="hidden" name="hr_id" value="{{Auth::guard('Hr')->user()->id}}">
                                    ...
                                    <div class="col-md-4"> 
                                        ...
                                        <input type="email" class="form-control" name="email" value="{{Auth::guard('Hr')->user()->email}}" id="validationCustom02" disabled required>
                                        <div class="valid-feedback">Looks good!</div>
                                    </div>
                                    <div class="col-md-4"> 
